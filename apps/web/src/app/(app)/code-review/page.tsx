        ...
        <div className="w-full pb-20 space-y-12">
            ...
            <div className="bg-white border-2 border-black relative min-h-[600px] flex flex-col items-center justify-center p-12 overflow-hidden group">
                ...
                <div className="relative z-10 flex flex-col items-center gap-10 max-w-2xl text-center">
                    <div className="w-24 h-24 border-2 border-black bg-white flex items-center justify-center relative shadow-none">
                        <img src="/suriken.png" alt="icon" className="w-10 h-10 black group-hover: transition-colors object-contain" style={{ "transform": "scale(2.2) translate(0px, 0px)" }} />
                    ...
                    <div className="space-y-6">
                        ...
                        <p className="text-[12px] tracking-[0.2em] font-black text-[#888888] uppercase leading-loose border-2 border-black/5 p-8 bg-[#F9F9F9]">
                            The static analysis cluster is undergoing deep synchronization.
                            All algorithmic review requests are held in the local buffer.
                            Level 2 Operative clearance required for emergency override.
                        </p>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-0 border-2 border-black bg-black p-[1px]">
                <div className="p-10 bg-white flex flex-col gap-6 group">
                    <div className="flex items-center gap-4">
                        <img src="/suriken.png" alt="icon" className="w-5 h-5 black group-hover: transition-colors object-contain" style={{ "transform": "scale(2.2) translate(0px, 0px)" }} />
                        <span className="text-[11px] tracking-[0.4em] uppercase font-black text-black">DEBUGGER SHELL</span>
                    </div>
                ...
                <div className="p-10 bg-white flex flex-col gap-6 items-end text-right group">
                    <div className="flex items-center gap-4">
                        <span className="text-[11px] tracking-[0.4em] uppercase font-black text-black">MEMORY DUMP</span>
                        <img src="/suriken.png" alt="icon" className="w-5 h-5 [#AAAAAA] group-hover:text-black transition-colors object-contain" style={{ "transform": "scale(2.2) translate(0px, 0px)" }} />
                    </div>
                    <p className="text-[12px] tracking-[0.2em] uppercase text-[#AAAAAA] font-black">CLEARANCE LEVEL 03 REQ</p>
                </div>
            </div>
        </div>
    );
