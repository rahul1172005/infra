...
export default function LearningPage() {
    return (
        <div className="w-full pb-24 space-y-16 relative overflow-hidden">
                ...
                <div className="space-y-8">
                    <div className="flex items-center gap-6">
                        <div className="w-20 h-20 flex items-center justify-center transition-transform duration-500 relative group/header">
                            <GOTIcon size={80} scale={1.2} x={0} y={0} />
                        </div>
                        <span className="text-[11px] tracking-[0.8em] font-black uppercase text-white/30">MAESTER LIBRARY ACCESS</span>
                    </div>
                    <h1 className="text-7xl md:text-9xl font-black tracking-tighter uppercase leading-[0.8] text-white">
                        ANCIENT<br /><span className="text-[#E81414]">SCROLLS</span>
                    </h1>
                </div>
                ...
                <div className="lg:col-span-8 space-y-12">
                    <div className="bg-black border-2 border-white/10 p-16 min-h-[550px] flex flex-col items-center justify-center text-center relative overflow-hidden group/stage hover:border-white/20 transition-all">
                        ...
                        <div className="relative z-10 mb-12 p-10 border-2 border-white/10 bg-white/5 group-hover:bg-black transition-all duration-500 overflow-hidden group/icon relative shadow-[0_0_30px_rgba(255,255,255,0.02)]">
                            <GOTIcon size={112} scale={1.2} x={0} y={1} className="transition-all z-10 relative" />
                        ...
                        <h2 className="text-5xl md:text-7xl font-black tracking-tighter uppercase text-white mb-8 border-b-8 border-[#E81414] pb-6 inline-block group-hover:scale-105 transition-transform duration-700">LIBRARY OF OLDTOWN</h2>
                        ...
                        <div className="bg-white p-12 border-2 border-white flex flex-col items-center gap-6 max-w-3xl mx-auto shadow-[0_0_50px_rgba(255,255,255,0.05)] relative overflow-hidden">
                            ...
                            <p className="text-[15px] tracking-[0.3em] font-black text-black uppercase leading-relaxed relative z-10">
                                The Great Library of Oldtown is currently transcribing new ancient
                                scrolls. Primary availability expected by the next moon.
                            </p>
                        </div>
                                ...
                                {[
                                    ...
                                    <div key={i} className="flex items-center gap-6 group/item cursor-pointer">
                                        <div className="w-10 h-10 border-2 border-black/10 flex items-center justify-center text-black/10 group-hover/item:bg-black group-hover/item:text-white transition-all">
                                            <GOTIcon size={32} scale={1} x={0} y={0} variant="black" className="transition-all" />
                                        </div>
            ...
            {/* Tactical Bottom Bar */}
            <div className="p-16 border-2 border-white/10 bg-black flex flex-col md:flex-row items-center justify-between gap-12 relative overflow-hidden group/footer">
                ...
                <div className="flex items-center gap-8 relative z-10">
                    <div className="p-4 border-2 border-[#E81414]">
                        <GOTIcon size={56} scale={1} x={0} y={0} />
                    </div>
                    <span className="text-[14px] tracking-[0.8em] uppercase text-white font-black group-hover:text-[#E81414] transition-colors">ENCRYPTED REALM STREAM</span>
                </div>
