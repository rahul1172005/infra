...
import { Terminal, Lock, ArrowRight, Github, Zap } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen bg-white flex items-center justify-center p-8 relative overflow-hidden selection:bg-[#E81414] selection:text-white">
            ...
            <motion.div
                ...
                className="w-full max-w-[450px] relative z-10 space-y-12"
            >
                {/* Brand Header */}
                <div className="flex flex-col items-center gap-6">
                    ...
                    <div className="text-center space-y-2">
                        ...
                        <p className="text-[9px] md:text-[10px] tracking-[0.3em] md:tracking-[0.4em] font-black text-[#AAAAAA] uppercase">Node_Authorization_Required</p>
                    </div>
                </div>

                {/* Login Form Container */}
                <div className="bg-white border-2 border-black p-10 md:p-12 space-y-10 relative">
                    <div className="absolute -top-0.5 -left-0.5 w-8 h-8 border-t-4 border-l-4 border-[#E81414] pointer-events-none" />
                    <div className="absolute -bottom-0.5 -right-0.5 w-8 h-8 border-b-4 border-r-4 border-black pointer-events-none" />

                    <form className="space-y-8" onSubmit={(e) => e.preventDefault()}>
                        <div className="space-y-3">
                            <label className="text-[10px] font-black uppercase tracking-[0.4em] text-[#888888] ml-1">Operative_Alias</label>
                            <div className="relative">
                                <Terminal className="absolute left-5 top-1/2 -translate-y-1/2 w-4 h-4 text-[#CCCCCC]" />
                                <input
                                    type="text"
                                    placeholder="ENTER HANDLE"
                                    className="w-full bg-[#F9F9F9] border-2 border-black py-5 pl-14 pr-6 text-black placeholder:text-[#BBBBBB] outline-none focus:bg-white transition-all text-sm font-black tracking-widest uppercase"
                                />
                            </div>
                        </div>
                        ...
                        <div className="space-y-3">
                            <div className="flex justify-between items-center ml-1">
                                <label className="text-[10px] font-black uppercase tracking-[0.4em] text-[#888888]">Direct_Key</label>
                            </div>
                            <div className="relative">
                        ...
                        <button className="w-full bg-black text-white font-black uppercase tracking-[0.5em] text-[12px] py-6 flex items-center justify-center gap-4 hover:bg-[#E81414] transition-all transform active:scale-[0.98]">
                            INITIATE AUTH <ArrowRight className="w-5 h-5" />
                        </button>
                    </form>
                ...
                <div className="text-center text-[11px] tracking-[0.2em] font-black uppercase">
                    <span className="text-[#AAAAAA]">Unauthorized?</span> <Link href="/auth/register" className="text-black hover:text-[#E81414] transition-colors border-b-2 border-black/5 pb-0.5">REGISTER OPERATIVE</Link>
                </div>
            </motion.div>
        </div>
    );
