...
export function Button({
  ...
  const variants = {
    primary: 'bg-white text-black hover:bg-[#E81414] hover:text-white shadow-lg shadow-white/5 border-2 border-transparent',
    secondary: 'bg-[#E81414] text-white hover:bg-white hover:text-black shadow-lg shadow-[#E81414]/10 border-2 border-transparent',
