...
export function MissionVision() {
 ...
 {/* Mission */}
 <div className="bg-black relative overflow-hidden group p-8 md:p-12 h-[350px] md:h-[450px] flex flex-col justify-between hover:bg-[#FFD700]/5 transition-colors cursor-pointer">
 ...
 <h3 className="text-[#FFD700] text-2xl md:text-3xl font-bold tracking-widest uppercase relative z-10 flex items-center gap-3">
 <span>/</span> MISSION
 </h3>
